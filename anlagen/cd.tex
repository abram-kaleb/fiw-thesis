...
Im Unterverzeichnis \texttt{tools} des Projekts findet sich das Perl-Skript \texttt{dirtree.pl}, mit welchem Inhalte für das dirtree-Environment (siehe oberhalb) semiautomatisch erstellt werden können.

Die Nutzung aus der Kommandozeile ist wie folgt:\\
\texttt{perl dirtree.pl /path/to/top/of/dirtree}
